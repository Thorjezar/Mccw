...
namespace McwdService
{
    ...
    {
        public static string connectionString = PubConstant.ConnectionString_mysql;
        ...
        public static DataSet Query(string SQLString)
        {
            using (MySqlConnection connection = new MySqlConnection(connectionString))
            {
                ...
                //String mysqlStr = "Database=test1;Data Source=127.0.0.1;User Id=root;Password=root;pooling=false;CharSet=utf8;";
                ...
                try
                {
                    ...
                    //mysqlConn.Open();
                    MySqlDataAdapter command = new MySqlDataAdapter(SQLString, connection);                   //mysqlStr
                    command.Fill(ds, "ds");
                }
